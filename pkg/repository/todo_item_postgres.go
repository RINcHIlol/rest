...
func (r *TodoItemPostgres) Create(listId int, item restApi.TodoItem) (int, error) {
	tx, err := r.db.Begin()
	if err != nil {
		return 0, err
	}
...
func (r *TodoItemPostgres) GetAll(userId, listId int) ([]restApi.TodoItem, error) {
...
func (r *TodoItemPostgres) GetById(userId, itemId int) (restApi.TodoItem, error) {
...
func (r *TodoItemPostgres) Update(userId, id int, input restApi.UpdateTodoItem) error {
